...
import { ChevronLeft, Calendar, DollarSign, Target, Activity, Share2 } from "lucide-react"
...
export default function AddAdsDataPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        // In a real app, we'd call a server action here to save to Supabase
        router.push("/dashboard?success=ads-submitted")
    }
        ...
        <div className="flex flex-col gap-6 animate-in slide-in-from-right duration-500 fill-mode-both">
            ...
            <div className="flex flex-col gap-1 relative pr-12">
                ...
                <p className="text-sm font-medium text-gray-500 leading-relaxed mt-2">
                    Update your daily campaign performance metrics for real-time editorial reporting.
                </p>
            </div>

            <form onSubmit={handleSubmit} className="bg-white rounded-[2.5rem] p-8 sm:p-10 shadow-[0_15px_60px_rgba(0,0,0,0.03)] ring-1 ring-gray-100 flex flex-col gap-6 mt-2">
                ...
                <div className="space-y-3">
                    ...
                    <div className="relative bg-[#F5F8FF]/40 h-14 rounded-2xl flex items-center px-4 overflow-hidden">
                        <div className="mr-2 text-gray-400 font-bold">$</div>
                        <div className="text-gray-900 font-bold">
                            {cpl.toFixed(2)}
                        </div>
                        <div className="absolute right-0 top-0 h-full w-12 bg-gradient-to-l from-white/20 to-transparent"></div>
                    </div>
                </div>
